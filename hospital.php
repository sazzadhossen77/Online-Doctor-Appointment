...
<div class="doc"><a href="hospital.php"> 1</a> </div>
<div class="doc"> 2</div>
<div class="search_Dr">
...
<?php
 ...
 ?>
<div class="box"><a href="hospital_profile.php  ?id=<?php echo $id; ?>"> <img src=" <?php echo $rows['pic'];?>"><h2><?php echo $rows['name'];?></h2></a></div>
